<h3>corporator Details - Admin View</h3>
<p>To add New corporator <a href="view.php?mod=Administrator&view=addEngg">Click Here</a> </p>
<form action="" method="post"  name="frmListUser" id="frmListUser">
  <table width="680" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
    <tr align="center" id="listTableHeader">
      <td width="453">corporator Name </td>
      <td width="">Email</td>
