...
<h3>Add New Corporator Details - Admin View</h3>
    ...
    <tr>
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <tr class="entryTable">
              <td class="label">&nbsp;Corporator Name</td>
              <td class="content"><input name="corporatorname" type="text" class="box" id="corporatorname" size="30" maxlength="20" /></td>
            </tr>
            <tr class="entryTable">
